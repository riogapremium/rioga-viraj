...
form.addEventListener('submit', (e) => {
	...
	let link = 'https://wa.link/7hti5l';
    let website = 'https://luxury-projects.co/lodha-bellevue-mahalaxmi/';
    ...
    .then(emailResponse => {
        ...
        window.location.href = "https://luxury-projects.co/lodha-bellevue-mahalaxmi/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
