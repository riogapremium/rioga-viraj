...
// Pop Up Close Code
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(formtypeData == "Payment Schedule")
         ...
         if(formtypeData == "3 BHK Flat Tour")
            formtype = "View 3 BHK Flat Tour"

          if(formtypeData == "4 BHK Flat Tour")
            formtype = "View 4 BHK Flat Tour"
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/K-MTNG';
        let website = 'http://luxury-projects.co/kalpataru-matru-ashish/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "http://luxury-projects.co/kalpataru-matru-ashish/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "http://luxury-projects.co/kalpataru-matru-ashish/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
