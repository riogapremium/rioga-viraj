...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $(".floorplanImg").each(function(){
            if($(this).attr("data-configDetails") == "4 BHK" || $(this).attr("data-configDetails") == "3.5 BHK" ){
                ...
                $(this).addClass("zoomImg")
                $(this).removeClass("formPopTrigger")
                $(this).removeClass("floorplanbackDrop")
...
// Video Thumbnail Close
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(formtypeData == "Play Video")
         ...
         if(formtypeData == "2 BHK Sample Flat Tour")
            formtype = "2 BHK Sample Flat Tour"

         if(formtypeData == "3 BHK Sample Flat Tour")
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/L-rsrvo';
        let website = 'https://luxury-projects.co/lodha-corinthia-bhandup/';
    ...
    .then(emailResponse => {
        ...
        // if($(location).attr("href") == "https://l-thane.com/")
        // {
        //     variques = "?"
        // }
        // else{
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://luxury-projects.co/lodha-corinthia-bhandup/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
