...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $(".aboutDB").removeClass("formPopTrigger")
        ...
        $(".playvideotrigger").removeClass("playvideotrigger")
...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/L-Mtnga';
        let website = 'https://luxury-projects.co/lodha-vero/';
        let salesnumber = '918291947281';
        let salesemail = 'sunilu@riogapremium.com';
        let salesname = 'Sunil U';

       let secondarysalesname = "Madhuri";
        let secondarysalesemail = "madhurid@riogapremium.com";
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://l-matunga.com/vero/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://luxury-projects.co/lodha-vero/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
