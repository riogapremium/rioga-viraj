...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $(".videoTigger").removeClass("videoTigger")
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let website = 'https://luxury-projects.co/lodha-divino/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://l-matunga.com")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://luxury-projects.co/lodha-divino/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
