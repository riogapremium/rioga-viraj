...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/WA-BKC';
        let website = 'https://wadhwa-artek.com/';
        let salesnumber = '917045006401';
        let salesemail = 'melroyp@riogapremium.com';
        let salesname = 'melroyp';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://wadhwa-artek.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
