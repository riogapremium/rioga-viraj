...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let website = 'https://luxury-projects.co/lnt-seawoods/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://luxury-projects.co/lnt-seawoods/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
