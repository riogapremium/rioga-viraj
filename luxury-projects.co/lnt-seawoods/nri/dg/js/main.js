...
// Form Submit Operations
    ...
    }else if(typeofDataForm == "Talk To Property Expert" || typeofDataForm == "Enquire Now"){
  ...
  <div>
        <div class="brochureImage">
          <img class="brochureimg" src="./img/brochure.webp" alt="Horizons Dadar">
        </div><button class="enquireNowBtn">Brochure has been downloaded</button></div>
`)
...
// Pop Up Close Code
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(formtypeData == "Talk To Property Expert"){
            $("#sitevisitform").show()
        }
...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/LNT-Sw';
        let website = 'https://luxury-projects.co/lnt-seawoods/dg/';
        let salesnumber = '917700980608';
        let salesemail = 'hiteshj@riogapremium.com';
        let salesname = 'Hitesh J';

        let secondarysalesname = "Vishwa V";
        let secondarysalesemail = "vishwav@riogapremium.com";
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://luxury-projects.co/lnt-seawoods/dg/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
