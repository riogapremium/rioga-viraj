...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/Ajmera-W';
        let website = 'https://luxury-projects.co/ajmera-manhattan-wadala/';
    ...
    .then(emailResponse => {
        ...
        window.location.href = "https://luxury-projects.co/ajmera-manhattan-wadala/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
