...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/R-swri';
        let website = 'https://luxury-projects.co/rustomjee-sewri/';
        let salesnumber = '917738806545';
        let salesemail = 'sagars@riogapremium.com';
        let salesname = 'Sagar S';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://luxury-projects.co/rustomjee-sewri/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://luxury-projects.co/rustomjee-sewri/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
