...
const typeWithDatetime = `${selectedType}  ${finalDateTime}`;
    ...
    //         console.log("First response:", responseText);
            ...
            let link = 'bit.ly/L-alibaug';
            let website = 'https://luxury-projects.co/lodha_alibaug/';
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "https://luxury-projects.co/lodha_alibaug/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
