...
form.addEventListener('submit', (e) => {
    ...
    //         console.log("First response:", responseText);
            ...
            let link = 'bit.ly/G-skyshore';
            let website = 'https://luxury-projects.co/godrej-skyshore-versova/';
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "https://luxury-projects.co/godrej-skyshore-versova/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
