...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $(".floorplanImg").addClass("floorplanbackDrop2")
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/Hrnd-B';
        let website = 'http://luxury-projects.co/hiranandani-bandra';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "http://luxury-projects.co/hiranandani-bandra/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
