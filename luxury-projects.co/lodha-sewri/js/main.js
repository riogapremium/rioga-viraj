...
// Form Submit Operations
    ...
    if(typeofDataForm == "Check Price" || typeofDataForm == "View Floor Plan" || typeofDataForm == "Download Plans"){
        ...
        $(".loadMessage").html("Brochure will be shared soon")
    ...
    if(dataShow == 'true'){
        ...
        $("#aboutDB").attr("href",null)
         ...
         $(".btnText").text("Brochure Will Be Shared Soon");
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/l-swri';
        let website = 'https://luxury-projects.co/lodha-sewri/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://luxury-projects.co/lodha-sewri/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://luxury-projects.co/lodha-sewri/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
