...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let website = 'https://luxury-projects.co/godrej-worli/os/';
    ...
    .then(emailResponse => {
        ...
        $("#submitBtn").css("pointer-events","unset");
            ...
            window.location.href = "https://luxury-projects.co/godrej-worli/os/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
