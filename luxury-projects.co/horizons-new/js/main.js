...
form.addEventListener('submit', (e) => {
    ...
    //         console.log("First response:", responseText);
        ...
        let link = 'bit.ly/GWHorizon';
        let website = 'https://luxury-projects.co/horizons-new/';
        let salesnumber = '917400477390';
        let salesemail = 'madhurid@riogapremium.com';
        let salesname = 'Madhuri D';
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "https://luxury-projects.co/horizons-new/thank-you.html?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
