...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $(".floorplanImg").each(function(){
            if($(this).attr("data-configDetails") == "4 BHK with Study"  ){
...
// Video Thumbnail Close
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(formtypeData == "Play Video")
         ...
         if(formtypeData == "2.5 BHK Sample Flat Tour")
            formtype = "2.5 BHK Sample Flat Tour"
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let website = 'https://luxury-projects.co/lodha-riservo-vikhroli/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://luxury-projects.co/lodha-riservo-vikhroli/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
