...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/S-swri';
        let website = 'https://luxury-projects.co/sobha-sewri/';
    ...
    .then(emailResponse => {
        ...
        window.location.href = "https://luxury-projects.co/sobha-sewri/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
    .catch(error => {
