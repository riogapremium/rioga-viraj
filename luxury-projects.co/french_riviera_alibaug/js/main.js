...
form.addEventListener('submit', (e) => {
    ...
    fetch('https://script.google.com/macros/s/AKfycbyZZh85c6V3-6wVcYRk2kuTNt2GOd_DZ_5NqlGco-zljNwTZnHIH7pPEV8DWkfnITYIRA/exec', {
        ...
        .then(responseText => {
            ...
            let link = 'bit.ly/French_Riviera_Alibaug';
            let website = 'https://luxury-projects.co/french_riviera_alibaug/';
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "https://luxury-projects.co/french_riviera_alibaug/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
