...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/Dpark-worli';
        let website = 'https://the-park-worli.com/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://the-park-worli.com/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://the-park-worli.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
