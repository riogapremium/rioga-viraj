...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/H-empress';
        let website = 'https://empresshill-powai.in/new/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://empresshill-powai.in/new/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://empresshill-powai.in/new/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
