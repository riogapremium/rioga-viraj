...
form.addEventListener('submit', (e) => {
    ...
    //         console.log("First response:", responseText);
            ...
            let link = 'bit.ly/Rm-Vvrea';
            let website = 'https://modern-vivarea.com/';
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "https://modern-vivarea.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
