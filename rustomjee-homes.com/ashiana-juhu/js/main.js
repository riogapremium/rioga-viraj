...
const typeWithDatetime = `${selectedType}  ${finalDateTime}`;
    ...
    fetch('https://script.google.com/macros/s/AKfycbyZZh85c6V3-6wVcYRk2kuTNt2GOd_DZ_5NqlGco-zljNwTZnHIH7pPEV8DWkfnITYIRA/exec', {
        ...
        .then(responseText => {
            ...
            let link = 'bit.ly/R-ashiana';
            let website = 'https://rustomjee-homes.com/ashiana-juhu/';
            ...
            console.log("timer 1");
            return fetch('https://riogapremium.in/server/sendmail2.php', { // Replace with your PHP email script
                method: 'POST',
                body: emailData
            });
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "https://rustomjee-homes.com/ashiana-juhu/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
