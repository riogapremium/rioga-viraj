...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        setTimeout(()=>{
            ...
            setTimeout(()=>{
                $(".loadingImgLeft").css("bottom","-50%")
                $(".loadingImgRight").css("top","-50%")
...
form.addEventListener('submit', (e) => {
    ...
    $(".loadingImgLeft").css("bottom","0%")
    $(".loadingImgRight").css("top","0%")
    ...
    // Fir  st fetch request to submit form data
    ...
    //         console.log("First response:", responseText);
            ...
            let link = 'bit.ly/Prestige-O';
            let website = 'https://prestige-oceantower.com/';
            let salesnumber = '917400002191';
            let salesemail = 'rayeesm@riogapremium.com';
            let salesname = 'Rayees M';
        ...
        .then(emailResponse => {
            ...
            if($(location).attr("href") == "https://prestige-oceantower.com/")
            {
                variques = "?"
            }
            else{
            ...
            window.location.href = "https://prestige-oceantower.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
