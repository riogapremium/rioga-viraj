...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/G-rsrv';
        let website = 'https://kandivalireserve.com/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://kandivalireserve.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
