...
form.addEventListener('submit', (e) => {
    ...
    fetch('https://script.google.com/macros/s/AKfycbyZZh85c6V3-6wVcYRk2kuTNt2GOd_DZ_5NqlGco-zljNwTZnHIH7pPEV8DWkfnITYIRA/exec', {
        ...
        .then(responseText => {
            ...
            let link = 'bit.ly/p-stg';
            let website = 'https://oceantowers-mumbai.com/os/';
            let salesnumber = '919820851321';
            let salesemail = 'yogeshr@riogapremium.com';
            let salesname = 'Yogesh R';
        ...
        .then(emailResponse => {
            ...
            if($(location).attr("href") == "https://oceantowers-mumbai.com/os")
            {
                variques = "?"
            }
            else{
            ...
            window.location.href = "https://oceantowers-mumbai.com/os?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
