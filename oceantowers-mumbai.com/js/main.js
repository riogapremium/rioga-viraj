...
form.addEventListener('submit', (e) => {
    ...
    //         console.log("First response:", responseText);
            ...
            let website = 'https://oceantowers-mumbai.com/';
            ...
            if($(location).attr("href") == "https://oceantowers-mumbai.com/")
            {
                variques = "?"
            }
            else{
            ...
            window.location.href = "https://oceantowers-mumbai.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
