...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/4jkm8AO';
        let website = 'https://forestville-thane.com/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            gtag_report_conversion();
             ...
             gtag('event', 'conversion', {'send_to': 'AW-16806208214/xWAUCOG8jtMaENbF6c0-'});


        }else{
            window.location.href = "https://forestville-thane.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
