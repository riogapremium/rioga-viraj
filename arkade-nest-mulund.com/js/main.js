...
// Form Submit Operations
    ...
    if(typeofDataForm == "Check Price" || typeofDataForm == "View Floor Plan" || typeofDataForm == "Download Plans"){
        // $(".loadMessage").html("<div class='loadMessageNew'>Unveiling latest Plans & Prices just for you<br>Please wait </div>")
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let website = 'https://arkade-nest-mulund.com/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://arkade-nest-mulund.com")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://arkade-nest-mulund.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
