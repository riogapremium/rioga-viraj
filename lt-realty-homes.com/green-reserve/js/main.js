...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/lnt-N-128';
        let website = 'https://lt-realty-homes.com/green-reserve/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://lt-realty-homes.com/green-reserve/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://lt-realty-homes.com/green-reserve/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
