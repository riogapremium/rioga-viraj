...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/lt-mumbai';
        let website = 'https://lt-realty-homes.com/';
        let salesnumber = '918655232562';
        let salesemail = 'nitinp@riogapremium.com';
        let salesname = 'Nitin P';

        let secondarysalesname = "Shushmita Bhosale";
        let secondarysalesemail = "sushmitab@riogapremium.com";
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://lt-realty-homes.com/")
        {
            variques = "?"
        }
        else{
