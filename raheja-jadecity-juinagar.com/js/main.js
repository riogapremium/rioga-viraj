...
// Pop Up Close Code
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(window.formtypeData == "4 BHK Sample flat tour")
            formtype = "4 BHK Sample flat tour"

        if(window.formtypeData == "2 BHK Sample flat tour")
            formtype = "2 BHK Sample flat tour"

        if(window.formtypeData == "3 BHK Sample flat tour")
            formtype = "3 BHK Sample flat tour"

        if(window.formtypeData == "Project Walkthrough")
        ...
        if(window.formtypeData == "Download Brochure")
            formtype = "Click to View Brochure"
