...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/OGC-Thne';
        let website = 'https://thane-garden-city.com/';
    ...
    .then(emailResponse => {
        ...
        window.location.href = "https://thane-garden-city.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
    })
    .catch(error => {
