...
// Pop Up Close Code
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(formtypeData == "Play Video")
         ...
         if(formtypeData == "4.5 BHK Sample Flat Tour")
...
// remove any old error message first
    ...
    //         console.log("First response:", responseText);
            ...
            let link = 'bit.ly/Pnshl-omnia';
            let website = 'http://panchshil-omnia-bandra.com/';
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "http://panchshil-omnia-bandra.com/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
