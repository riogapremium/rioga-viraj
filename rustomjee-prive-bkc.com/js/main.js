...
// Form Submit Operations
    ...
    }else if(typeofDataForm == "Download Brochure<br>Will Share Soon"){
  ...
  <div>
        <div class="brochureImage">
          <img class="brochureimg" src="./img/brochure.webp" alt="Adani Airica">
        </div><button class="enquireNowBtn">Brochure Will Be Shared Soon</button></div>
`)
        ...
        $(".floorplanbackDrop").each(function(){
            if($(this).attr("data-configDetails") == "3 BHK" || $(this).attr("data-configDetails") == "3 BHK Grande"  || $(this).attr("data-configDetails") == "3 BHK Luxe" ){
...
// Pop Up Close Code
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(formtypeData == "Palatial 3 BHK")
            formtype = "Palatial 3 BHK"

        if(formtypeData == "Expansive 3 BHK")
            formtype = "Expansive 3 BHK"
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/prive-bkc';
        let website = 'https://rustomjee-prive-bkc.com/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://rustomjee-prive-bkc.com/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://rustomjee-prive-bkc.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
