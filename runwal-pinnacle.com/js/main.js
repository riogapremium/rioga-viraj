...
`)
        ...
        $(".floorplanbackDrop").each(function(){
            if($(this).attr("data-configDetails") == "Crown Penthouse" || $(this).attr("data-configDetails") == "Duplex"){
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/RNwl-P';
        let website = 'https://runwal-pinnacle.com/';
	...
	emailData.append('sitekey', form.sitekey.value);
        ...
        if($(location).attr("href") == "https://runwal-pinnacle.com/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://runwal-pinnacle.com/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
