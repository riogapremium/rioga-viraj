...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        // $(".floorplanImg").addClass("zoomImg")
         ...
         $(".virtualtouroverlay").removeClass("formPopTrigger")
         $(".virtualtouroverlay").removeClass("virtualtouroverlay")
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/PMhlxmi';
        let website = 'https://p-mahalaxmi.com/';
        ...
        if($(location).attr("href") == "https://p-mahalaxmi.com/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://p-mahalaxmi.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
