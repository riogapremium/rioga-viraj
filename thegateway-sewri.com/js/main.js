...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $(".locMapBlur").removeClass("locMapBlur");
         ...
         $(".videoTitle").removeClass("formPopTrigger");

         $(".virtualvdo").removeClass("formPopTrigger");
         $(".virtualvdo").removeClass("floorplanbackDrop2");
         $(".virtual iframe").css("pointer-events","unset !important");
...
// Pop Up Close Code
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(window.formtypeData == "Schedule a Site Visit")
            formtype = "Schedule a Site Visit"

        if(window.formtypeData == "4.5 BHK Flat Tour")
            formtype = "4.5 BHK Sample Flat Tour"

        if(window.formtypeData == "4 BHK Flat Tour")
            formtype = "4 BHK Sample Flat Tour"

        if(window.formtypeData == "3 BHK Flat Tour")
            formtype = "3 BHK Sample Flat Tour"
        ...
        if(window.formtypeData == "Check Price" || window.formtypeData == "View Floor Plan" ){
            ...
            if(window.formtypeData == "Check Price")
            {
                formtype = "Check Price"
            }else if(window.formtypeData == "View Floor Plan")
            {
                formtype = "View Floor Plan"
            }
