...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/R-CLEON';
        let website = 'https://rustomjee-bkc.co/aden-bkc-annexe';
        let salesnumber = '917400167057';
        let salesemail = 'rajeshkumarp@riogapremium.com';
        let salesname = 'Rajeshkumar P';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://rustomjee-bkc.co/cleon-bkc-annexe/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://rustomjee-bkc.co/cleon-bkc-annexe/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
