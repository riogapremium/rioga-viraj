...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/SB-chmbr';
        let website = 'https://supremes-boulevard.com/competition/';
        let salesnumber = '917400161219';
        let salesemail = 'utprekshad@riogapremium.com';
        let salesname = 'Utpreksha D';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://supremes-boulevard.com/competition")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://supremes-boulevard.com/competition?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
