...
// Video Thumbnail Close
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(formtypeData == "View Virtual Tour")
            formtype = "View Virtual Tour"
...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/SB-chm';
        let website = 'https://supremes-boulevard.com/chembur/';
        let salesnumber = '917700960480';
        let salesemail = 'shwetam@riogapremium.com';
        let salesname = 'Shweta M';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://supremes-boulevard.com/chembur/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://supremes-boulevard.com/chembur/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
