...
// Pop Up Close Code
	...
	if(formtypeData == "Sample Flat Tour")
            formtype = "Sample Flat Tour"
...
form.addEventListener('submit', (e) => {
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://theprestigecity-mulund.com/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://theprestigecity-mulund.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
