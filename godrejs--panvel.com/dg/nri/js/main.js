...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/GGT-Pnvl';
        let website = 'https://godrejs--panvel.com/nri/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://godrejs--panvel.com/nri/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
