...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $(".floorplanbackDrop").each(function(){
            if($(this).attr("data-configDetails") == "5 BHK" ){
...
// Video Thumbnail Close
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(formtypeData == "3 BHK Show Flat Tour")
            formtype = "3 BHK Show Flat Tour"
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/G-skytc';
        let website = 'https://g-skyterraces.com/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://g-skyterraces.com/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://g-skyterraces.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
