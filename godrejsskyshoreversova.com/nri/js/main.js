...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        <div>
                ...
                <img class="brochureimg" src="./img/brochure.webp" alt="Godrej Skyshore">
	...
	$(".actual_payment").each(function(){
        ...
        //Virtual 360
         ...
         $(".virtualouterpop").removeClass("virtual360");
...
// Pop Up Close Code
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(formtypeData == "Location AV")
            formtype = "View Location AV"


         if(formtypeData == "Virtual 360 Tour")
            formtype = "Virtual 360 Tour"
...
form.addEventListener('submit', (e) => {
    ...
    fetch('https://script.google.com/macros/s/AKfycbyZZh85c6V3-6wVcYRk2kuTNt2GOd_DZ_5NqlGco-zljNwTZnHIH7pPEV8DWkfnITYIRA/exec', {
        ...
        .then(responseText => {
            ...
            let link = 'bit.ly/G-skys';
            let website = 'https://godrejsskyshoreversova.com/nri/';
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "https://godrejsskyshoreversova.com/nri/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
