...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/180b-view';
        let website = 'https://180-bayview-matunga.com/';
        ...
        window.location.href = "https://180-bayview-matunga.com/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
