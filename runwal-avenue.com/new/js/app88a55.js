...
function SwiperSlider() {
  var swiper = new Swiper('#gallery-carousel', {
   ...
   var swiper = new Swiper('#gallery-carousel4', {
    direction: "horizontal",
    loop: false,
    grabCursor: true,
    resistance: true,
   ...
   var swiper = new Swiper('#gallery-carousel5', {
    direction: "horizontal",
    loop: false,
    grabCursor: true,
    resistance: true,
  ...
  var swiper = new Swiper('#gallery-carousel2', {
   ...
   var swiper = new Swiper('#gallery-carousel3', {
    direction: "horizontal",
    loop: true,
    grabCursor: true,
    resistance: true,
  ...
  var swiper = new Swiper('#amenities-carousel1', {
    direction: "horizontal",
    loop: false,
    grabCursor: true,
    resistance: true,
  ...
  var swiper = new Swiper('#amenities-carousel2', {
    direction: "horizontal",
    loop: false,
    grabCursor: true,
    resistance: true,
  ...
  var swiper = new Swiper('#amenities-carousel4', {
    direction: "horizontal",
    loop: false,
    grabCursor: true,
    resistance: true,
