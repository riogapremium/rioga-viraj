...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/R-Avnue';
        let website = 'https://runwal-avenue.com/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            $(".videomain").removeClass("formPopTrigger, blur1")
            ...
            window.location.href = "https://runwal-avenue.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
