...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/GPrime-C';
        let website = 'https://riogapremium.in/godrej-prime-chembur/';
        let salesnumber = '7700960480';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://riogapremium.in/godrej-prime-chembur?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
