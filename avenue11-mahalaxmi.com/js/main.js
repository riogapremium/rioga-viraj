...
form.addEventListener('submit', (e) => {
    ...
    //         console.log("First response:", responseText);
            ...
            let link = 'bit.ly/gdrj-11';
            let website = 'https://avenue11-mahalaxmi.com/';
        ...
        .then(emailResponse => {
            ...
            if(form.type.value == "Play Video"){
                ...
                window.location.href = "https://avenue11-mahalaxmi.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
            }
