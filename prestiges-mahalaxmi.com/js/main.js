...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/P-jsdan';
        let website = 'https://prestiges-mahalaxmi.com/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://prestiges-mahalaxmi.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
