 ...
 $(".slide-submit button").draggable({cancel: false, containment: "parent", axis: "x", stop: function() {
	...
	if (($(this).parent().width()/2) < ($(this).position().left + 100)) {
		...
		location.href = "https://api.whatsapp.com/send/?phone=%2B917400002191&text=I%E2%80%99m+interested+in+the+Prestige+Nautilus+project+at+Worli.+Please+send+brochure+and+price+details.&type=phone_number&app_absent=0";
