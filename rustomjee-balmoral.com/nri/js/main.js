...
form.addEventListener('submit', (e) => {
    ...
    fetch('https://script.google.com/macros/s/AKfycbyZZh85c6V3-6wVcYRk2kuTNt2GOd_DZ_5NqlGco-zljNwTZnHIH7pPEV8DWkfnITYIRA/exec', {
        ...
        .then(responseText => {
            ...
            let link = 'bit.ly/R-chembur';
            let website = 'https://rustomjee-balmoral.com/nri/';
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "https://rustomjee-balmoral.com/nri/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
