...
// Pop Up Close Code
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(formtypeData == "3.5 BHK Sample Flat Tour")
            formtype = "3.5 BHK Sample Flat Tour"

        if(formtypeData == "4 BHK Sample Flat Tour")
            formtype = "4 BHK Sample Flat Tour"

        if(formtypeData == "5 BHK Sample Flat Tour")
            formtype = "5 BHK Sample Flat Tour"

        if(formtypeData == "Play Video")
            formtype = "Play Video"

         if(formtypeData == "Request to Call Back")
            formtype = "Request to Call Back"
...
// remove any old error message first
    ...
    //         console.log("First response:", responseText);
            ...
            let link = 'bit.ly/48XvjWq';
            let website = 'https://rustomjee-balmoral.com/';
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "https://rustomjee-balmoral.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
