...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/Sobha-Inizio';
        let website = 'https://sobha-parel.co/nri/';
	...
	emailData.append('sitekey', form.sitekey.value);
        ...
        if($(location).attr("href") == "https://sobha-parel.co/nri/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://sobha-parel.co/nri/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
