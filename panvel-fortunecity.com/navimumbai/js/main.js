...
form.addEventListener('submit', (e) => {
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://panvel-fortunecity.com/navimumbai/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://panvel-fortunecity.com/navimumbai?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
