...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/43Ox6ZJ';
        let website = 'https://rustomjee-crescent-bandra.com/';
        let salesnumber = '919867160002';
        let salesemail = 'aasims@riogapremium.com';
        let salesname = 'Asim S';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://rustomjee-crescent-bandra.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
