...
// Pop Up Close Code
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(formtypeData == "Download Plans")
            formtype = "Download Plans"
...
form.addEventListener('submit', (e) => {
	...
	emailData.append('sitekey', form.sitekey.value);
        ...
        return fetch('https://riogapremium.in/server/sendmail3.php', { // Replace with your PHP email script
         ...
         .then(res => res.text())
         .then(emailResponse => {
                window.location.href = "https://arkade-rare-bhandup.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
