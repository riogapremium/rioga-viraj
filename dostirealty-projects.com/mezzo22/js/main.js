...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/Dosti-Mezzo22';
        let website = 'https://dostirealty-projects.com/mezzo22/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://dostirealty-projects.com/mezzo22?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
