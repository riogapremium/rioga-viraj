...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/lnt-icm';
        let website = 'https://island-cove-mahim.com/competition/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://island-cove-mahim.com/competition?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
