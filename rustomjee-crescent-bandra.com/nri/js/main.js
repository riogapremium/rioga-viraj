...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/R-crescentB';
        let website = 'https://rustomjee-crescent-bandra.com/nri/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://rustomjee-crescent-bandra.com/nri/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
