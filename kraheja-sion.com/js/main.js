...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $("#mainVideo").removeClass("formPopTrigger")
        $("#mainVideo").removeClass("dnHeroimageOuter2")        
...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/KR-amaltis';
        let website = 'https://kraheja-sion.com/';
    ...
    .then(emailResponse => {
        ...
        window.location.href = "https://kraheja-sion.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
