...
form.addEventListener('submit', (e) => {
    ...
    let website = 'https://bellevue-mahalaxmi.co/os/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://bellevue-mahalaxmi.co/os")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://bellevue-mahalaxmi.co/os?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
