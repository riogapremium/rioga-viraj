 ...
 $(".slide-submit button").draggable({cancel: false, containment: "parent", axis: "x", stop: function() {
	...
	if (($(this).parent().width()/2) < ($(this).position().left + 100)) {
		...
		// window.open(
		// 	'https://api.whatsapp.com/send?phone=+919136497702&amp;text=I’m interested in the Godrej Bhandup project. Please send brochure and price details.',
		...
		location.href = "https://wa.me/+919136497702?text=I’m+interested+in+Godrej+Urban+Park.+Please+send+brochure+and+price+details.";
