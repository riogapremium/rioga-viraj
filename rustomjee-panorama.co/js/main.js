...
form.addEventListener('submit', (e) => {
    ...
    //         console.log("First response:", responseText);
            ...
            let link = 'bit.ly/RP-Bndra';
            let website = 'https://rustomjee-panorama.co/';
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "https://rustomjee-panorama.co?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
