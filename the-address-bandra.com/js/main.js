...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/Rymond-Bandra';
        let website = 'https://the-address-bandra.com/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://the-address-bandra.com/")
        {
            variques = "?"
        }
        else{
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://the-address-bandra.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
