...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $(".floorplanbackDrop").addClass("floorplanback2Drop")
...
form.addEventListener('submit', (e) => {
    ...
    fetch('https://script.google.com/macros/s/AKfycbyZZh85c6V3-6wVcYRk2kuTNt2GOd_DZ_5NqlGco-zljNwTZnHIH7pPEV8DWkfnITYIRA/exec', {
        ...
        .then(responseText => {
            ...
            let link = 'bit.ly/B-silas';
            let website = 'https://birla-niyaara-worli.com/';
        ...
        .then(emailResponse => {
            ...
            if($(location).attr("href") == "https://birla-niyaara-worli.com/")
            {
                variques = "?"
            }
            else{
