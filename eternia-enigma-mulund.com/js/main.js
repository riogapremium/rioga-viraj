...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/Obroi-M';
        let website = 'https://eternia-enigma-mulund.com/';
	...
	emailData.append('sitekey', form.sitekey.value);
        ...
        if($(location).attr("href") == "https://eternia-enigma-mulund.com/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://eternia-enigma-mulund.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
