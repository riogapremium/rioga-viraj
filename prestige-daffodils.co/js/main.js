...
form.addEventListener('submit', (e) => {
    ...
    //         console.log("First response:", responseText);
            ...
            let link = 'bit.ly/P-Dffodls';
            let website = 'https://prestige-daffodils.co/';
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "https://prestige-daffodils.co?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
