...
form.addEventListener('submit', (e) => {
    ...
    //         console.log("First response:", responseText);
            ...
            let link = 'bit.ly/Birla-Anayu';
            let website = 'https://birlas-anayu.com/';
        ...
        .then(emailResponse => {
            ...
            //     variques = "?"
            // }
            window.location.href = "https://birlas-anayu.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        })
        .catch(error => {
