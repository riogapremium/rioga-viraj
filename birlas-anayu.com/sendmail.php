...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $mail->Body = "
            ...
            <br>
            Should you wish to speak to us directly in the meantime, feel free to call us at +917400002191<br> or<br>
        ...
        $recipients = [
            ...
            'rayeesm@riogapremium.com' => 'Rayees M',
    ...
    // smscodeStarts
        ...
        \"realTimeResponse\": \"1\", \n  
        \"recipients\": [\n    {\n      
        \"mobiles\": \"917400002191, 918291947281, 917400493119\",\n      
