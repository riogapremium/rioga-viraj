        ...
        if(formtypeData == "Download Brochure")
         ...
         if(formtypeData == "3 BHK Sample Flat Tour")
          ...
          if(formtypeData == "4 BHK Sample Flat Tour")
           ...
           if(formtypeData == "4.5 BHK Sample Flat")
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/k-magnus';
        let website = 'https://kalpatarumagnus-bkc.com/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://kalpatarumagnus-bkc.com/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://kalpatarumagnus-bkc.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
