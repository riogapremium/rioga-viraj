...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let website = 'https://rustomjee-crown-prabhadevi.in/nri';
    ...
    .then(emailResponse => {
        ...
        window.location.href = "https://rustomjee-crown-prabhadevi.in/nri?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }  
    })
    .catch(error => {
