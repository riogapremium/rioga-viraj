...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/Rstmj-crown';
        let website = 'https://rustomjee-crown-prabhadevi.in/';
        let salesnumber = '917400427884';
        let salesemail = 'devendrap@riogapremium.com';
        let salesname = 'Devendra P';
        ...
        if($(location).attr("href") == "https://rustomjee-crown-prabhadevi.in")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://rustomjee-crown-prabhadevi.in?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }  
    })
    .catch(error => {
