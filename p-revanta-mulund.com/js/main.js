...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        <div class="brochureImage">
          <img class="brochureimg" src="./img/brochure-img.webp" alt="Raheja Antares">
...
`       )
        ...
        // Floor Plan Visible
        //  $(".floorplanbackDrop").addClass("zoomImg")
        // /$(".floorplanbackDrop").removeClass("formPopTrigger")
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/P-rvnta';
        let website = 'https://p-revanta-mulund.com/';
        let salesnumber = '919004455044';
