...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $link = "bit.ly/GH-wadala";
    $website = "https://horizons-dadar-wadala.com/";
    $salesnumber = "917045006401";


    $ProjectName = htmlspecialchars($_POST['project_name'] ?? '');
    $namenew = htmlspecialchars($_POST['name'] ?? '');
    $email = htmlspecialchars($_POST['email'] ?? 'blank@riogapremium.com');
        ...
        "recipients" => [
            [
                "to" => [
                    ...
                    ["name" => "Melroy P", "email" => "melroyp@riogapremium.com"],
