 ...
 $(".slide-submit button").draggable({cancel: false, containment: "parent", axis: "x", stop: function() {
	...
	if (($(this).parent().width()/2) < ($(this).position().left + 100)) {
		...
		location.href = "https://api.whatsapp.com/send?phone=+917045006401&text=I%27m+interested+in+Sea+View+Homes+at+GODREJ+HORIZON+at+Dadar-Wadala.+Please+send+launch+offers+and+details.";
