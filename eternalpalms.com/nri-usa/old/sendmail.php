...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $mail->Body = "
            ...
            <br>
            Should you wish to speak to us directly in the meantime, feel free to call us at +917506525717<br> or<br>
        ...
        $recipients = [
            ...
            'hiteshj@riogapremium.com' => 'Hitesh J',
        ];
    ...
    // smscodeStarts
        ...
        \"realTimeResponse\": \"1\", \n  
        \"recipients\": [\n    {\n      
        \"mobiles\": \"917506525717, 917400493119\",\n      
