...
// Form Submit Operations
  ...
  <div>
        <div class="brochureImage">
          <img class="brochureimg" src="./img/brochure.jpg" alt="">
...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/G-EPALMS';
        let website = 'https://eternalpalms.com/';
        let salesnumber = '917400433597';
        let salesemail = 'khushbook@riogapremium.com';
        let salesname = 'Khushboo K';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://eternalpalms.com/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "http://eternalpalms.com/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
