...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $(".floorplanImg").each(function(){
            if($(this).attr("data-configDetails") == "3 BHK Platina" ||  $(this).attr("data-configDetails") == "4 BHK Regal" ||  $(this).attr("data-configDetails") == "4 BHK Platina" ){
...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/GEP-snpd';
        let website = 'https://eternalpalms.com/nri-uae/';
        let salesnumber = '918655232562';
        let salesemail = 'sushmitab@riogapremium.com,';
        let salesname = 'Sushmita B';

        let secondarysalesname = "Nitin P";
        let secondarysalesemail = "nitinp@riogapremium.com";
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://eternalpalms.com/nri-uae/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "http://eternalpalms.com/nri-uae/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
