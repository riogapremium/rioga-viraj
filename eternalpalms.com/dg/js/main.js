...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/G-etrnal';
        let website = 'https://eternalpalms.com/dg/';
        let salesnumber = '917400334771';
        let salesemail = 'rafitb@riogapremium.com';
        let salesname = 'Rafit B';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://eternalpalms.com/dg/")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "http://eternalpalms.com/dg/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
