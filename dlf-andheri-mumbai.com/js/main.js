...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/DLF-ad';
        let website = 'https://dlf-andheri-mumbai.com/';
    ...
    .then(emailResponse => {
        ...
        if($(location).attr("href") == "https://dlf-andheri-mumbai.com")
        {
            variques = "?"
        }
        else{
        ...
        window.location.href = "https://dlf-andheri-mumbai.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
