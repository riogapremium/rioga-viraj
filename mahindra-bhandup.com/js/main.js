...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/mahindrabhandup';
        let website = 'https://pre-launch-project.com/mahindra-lifespaces-bhandup/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://pre-launch-project.com/mahindra-lifespaces-bhandup/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
