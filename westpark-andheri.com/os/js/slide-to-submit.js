 ...
 $(".slide-submit button").draggable({cancel: false, containment: "parent", axis: "x", stop: function() {
	...
	if (($(this).parent().width()/2) < ($(this).position().left + 100)) {
		...
		// window.open(
		// 	'https://api.whatsapp.com/send?phone=+919136413140&amp;text=I’m interested in the DLF Bhandup project. Please send brochure and price details.',
		...
		location.href = "https://wa.me/+919136413140?text=I’m+interested+in+DLF+Andheri.+Please+send+brochure+and+price+details.";
