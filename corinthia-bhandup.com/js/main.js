...
// Form Submit Operations
    ...
    if(dataShow == 'true'){
        ...
        $(".floorplanImg").each(function(){
            if($(this).attr("data-configDetails") == "Penthouse"){
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let website = 'https://corinthia-bhandup.com/';
	...
	emailData.append('sitekey', form.sitekey.value);
        ...
        // }
                   ...
                   window.location.href = "https://corinthia-bhandup.com/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
