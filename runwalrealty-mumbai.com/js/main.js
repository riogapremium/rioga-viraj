...
$(".thanks-msg").removeClass("thanks-msg");
...
// Pop Up Close Code
    ...
    $(".formPopTrigger").click(function(){
        ...
        if(formtypeData == "View Master Plan")
            formtype = "View Master Plan"
        ...
        if(formtypeData == "Project 360&#37; View"){

            formtype = "Project 360&#37; View"
            
        }

        if(formtypeData == "Project Walkthrough"){

            formtype = "Project Walkthrough"
...
form.addEventListener('submit', (e) => {
    ...
    // .then(responseText => {
        ...
        let link = 'bit.ly/Rnwl-R';
        let website = 'https://riogapremium.in/runwal-mumbai-projects/';
        let salesnumber = '917400448642';
        let salesemail = 'snehald@riogapremium.com';
        let salesname = 'Snehal d';

        let secondarysalesname = "Aasim S";
        let secondarysalesemail = "aasims@riogapremium.com";
    ...
    .then(emailResponse => {
        ...
        window.location.href = "https://runwalrealty-mumbai.com/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
