...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let website = 'https://horizons-dadar-wadala.com/nri';
    ...
    .then(emailResponse => {
        ...
        $("#submitBtn").css("pointer-events","unset");
            ...
            window.location.href = "https://horizons-dadar-wadala.com/nri/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
