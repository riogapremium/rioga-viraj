...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/G-cbreeze';
        let website = 'https://godrej-bayview-vashi.com/';
        let salesnumber = '917506525717';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://godrej-bayview-vashi.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
