...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/Purva-C';
        let website = 'https://purvaclermont-chembur.com/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://purvaclermont-chembur.com?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
