...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/LD-lumis';
        let website = 'https://ncp-wadala.com/aura/';
    ...
    .then(emailResponse => {
        ...
        if(form.type.value == "Play Video"){
            ...
            window.location.href = "https://ncp-wadala.com/aura?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
        }
