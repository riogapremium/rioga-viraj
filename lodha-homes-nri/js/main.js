...
form.addEventListener('submit', (e) => {
    ...
    .then(responseText => {
        ...
        let link = 'bit.ly/Mumbai-Ldha';
        let website = 'https://riogapremium.in/lodha-homes-nri/';
    ...
    .then(emailResponse => {
        ...
        window.location.href = "https://riogapremium.in/lodha-homes-nri/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
    })
    .catch(error => {
