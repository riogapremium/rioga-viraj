...
const typeWithDatetime = `${selectedType}  ${finalDateTime}`;
    ...
    // .then(responseText => {
        ...
        let link = 'https://wa.link/n8m2xc';
        let website = 'https://godrejtrilogy-worli.com/os/';
    ...
    .then(emailResponse => {
        ...
        $("#submitBtn").css("pointer-events","unset");
            ...
            window.location.href = "https://godrejtrilogy-worli.com/os/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
