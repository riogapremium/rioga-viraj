...
const typeWithDatetime = `${selectedType}  ${finalDateTime}`;
    ...
    // .then(responseText => {
        ...
        let link = 'https://wa.link/8sm99g';
        let website = 'https://godrejtrilogy-worli.com/nri/';
    ...
    .then(emailResponse => {
        ...
        $("#submitBtn").css("pointer-events","unset");
            ...
            window.location.href = "https://godrejtrilogy-worli.com/nri/?showData=true&type=" + formtypeData + "&plan=" + plantrigger;
